            ...
            if (req.inputData) {
                for (const binding of req.inputData) {
                    ...
                    if ((0, isTrigger_1.isHttpTrigger)(bindingType) && (0, setup_1.isHttpStreamEnabled)()) {
                        ...
                        input = new HttpRequest_1.HttpRequest(Object.assign(Object.assign({}, (_a = binding.data) === null || _a === void 0 ? void 0 : _a.http), { proxyRequest }));
                    }
                    else {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.generic = exports.warmup = exports.cosmosDB = exports.eventGrid = exports.eventHub = exports.serviceBusTopic = exports.serviceBusQueue = exports.storageQueue = exports.storageBlob = exports.timer = exports.http = exports.deleteRequest = exports.patch = exports.post = exports.put = exports.get = exports.setup = exports.hook = void 0;
...
var _HttpRequest_instances, _HttpRequest_cachedUser, _HttpRequest_uReq, _HttpRequest_init, _HttpRequest_initInMemoryRequest, _HttpRequest_initStreamRequest;
Object.defineProperty(exports, "__esModule", ({ value: true }));
...
class HttpRequest {
    constructor(init) {
        ...
        if (init.proxyRequest) {
            _a = this, [({ set value(_c) { __classPrivateFieldSet(_a, _HttpRequest_uReq, _c, "f"); } }).value, this.query, this.params] = __classPrivateFieldGet(this, _HttpRequest_instances, "m", _HttpRequest_initStreamRequest).call(this, init);
        }
        else {
            _b = this, [({ set value(_c) { __classPrivateFieldSet(_b, _HttpRequest_uReq, _c, "f"); } }).value, this.query, this.params] = __classPrivateFieldGet(this, _HttpRequest_instances, "m", _HttpRequest_initInMemoryRequest).call(this, init);
        }
    }
    get url() {
...
_HttpRequest_cachedUser = new WeakMap(), _HttpRequest_uReq = new WeakMap(), _HttpRequest_init = new WeakMap(), _HttpRequest_instances = new WeakSet(), _HttpRequest_initInMemoryRequest = function _HttpRequest_initInMemoryRequest(init) {
    var _a, _b, _c;
    ...
    const query = new url_1.URLSearchParams((0, fromRpcNullable_1.fromNullableMapping)(init.nullableQuery, init.query));
    const params = (0, fromRpcNullable_1.fromNullableMapping)(init.nullableParams, init.params);
    return [uReq, query, params];
}, _HttpRequest_initStreamRequest = function _HttpRequest_initStreamRequest(init) {
    var _a;
    const proxyReq = (0, nonNull_1.nonNullProp)(init, 'proxyRequest');
